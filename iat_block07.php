...
function nextItem(){
	...
	if (count_i <= maxTrialnum){
		...
		document.frmUploadData07.strBlock.value = strAllComposeString;
...
function save2Cookie(strBlockContent){
	...
	setCookies('block07',strBlockContent,expireDay);
}
...
function nextBlock(){
	location.href = 'iat_blockEnd.php';
}
...
<form id="frmUploadData07" name="frmUploadData07" method="post" action="ajax_save_uploaddata.php">
    <input type="hidden" name="BlockArea" value="Block7" />

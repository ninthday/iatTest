...
function nextItem(){
	...
	if (count_i <= maxTrialnum){
		...
		document.frmUploadData03.strBlock.value = strAllComposeString;
...
function save2Cookie(strBlockContent){
	...
	setCookies('block03',strBlockContent,expireDay);
}
...
<form id="frmUploadData03" name="frmUploadData03" method="post" action="ajax_save_uploaddata.php">
    <input type="hidden" name="BlockArea" value="Block3" />

...
function save2Cookie(strTrialnum, strResponse, strCorrect, strStimulus){
	...
	setCookies('b03Trialnum',strTrialnum,expireDay);
	setCookies('b03Response',strResponse,expireDay);
	setCookies('b03Correct',strCorrect,expireDay);
	setCookies('b03Stimulus',strStimulus,expireDay);
}

function delAllcookies(){
	delCookies('b03Trialnum');
	delCookies('b03Response');
	delCookies('b03Correct');
	delCookies('b03Stimulus');
}
</script> 

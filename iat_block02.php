...
var iatItem = ['重視','親近','喜愛','珍惜','獲得','捨棄','遠離','厭惡','拒絕','排斥'];
var iatResponse = ['l','l','l','l','l','r','r','r','r','r'];
var iatTrialcode = ['need-l','need-l','need-l','need-l','need-l','NONneed-r','NONneed-r','NONneed-r','NONneed-r','NONneed-r'];
...
function nextItem(){
	...
	if (count_i <= maxTrialnum){
		...
		document.frmUploadData02.strBlock.value = strAllComposeString;
...
function save2Cookie(strBlockContent){
	...
	setCookies('block02',strBlockContent,expireDay);
}
...
<div id="IAT_area">
	<div id="top">
	<span id="topleft">喜好</span><span id="topright">討厭</span>
	</div>
...
<form id="frmUploadData02" name="frmUploadData02" method="post" action="ajax_save_uploaddata.php">
    <input type="hidden" name="BlockArea" value="Block2" />

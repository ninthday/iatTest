...
function nextItem(){
	...
	if (count_i <= maxTrialnum){
		...
		document.frmUploadData01.strBlock.value = strAllComposeString;
...
function save2Cookie(strBlockContent){
	...
	setCookies('block01',strBlockContent,expireDay);
}
...
<div id="IAT_area">
	...
	<div id="stimulus" align="center"><font color="#FFFFFF">把食指放在鍵盤上的「E」和「I」<br />準備好請按下 空白鍵 開始</font></div>
...
<form id="frmUploadData01" name="frmUploadData01" method="post" action="ajax_save_uploaddata.php">
    <input type="hidden" name="BlockArea" value="Block1" />

...
function nextItem(){
	...
	if (count_i <= maxTrialnum){
		...
		document.frmUploadData06.strBlock.value = strAllComposeString;
...
function save2Cookie(strBlockContent){
	...
	setCookies('block06',strBlockContent,expireDay);
}
...
<form id="frmUploadData06" name="frmUploadData06" method="post" action="ajax_save_uploaddata.php">
    <input type="hidden" name="BlockArea" value="Block6" />
